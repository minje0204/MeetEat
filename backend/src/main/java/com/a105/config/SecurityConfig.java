...
import com.a105.security.RestAuthenticationEntryPoint;
import com.a105.security.TokenAuthenticationFilter;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            ...
            .antMatchers("/",
                ...
                "/**/*.js")
            .permitAll()
            .antMatchers("/auth/**", "/oauth2/**", "/friend/**", "/user/**", "/restaurant/**", "/groupcall/**")
            .permitAll()
            .anyRequest()
            .authenticated()
            .and()
